...
class StaffAttndStats{
	int todaysCount;
	List<Integer> dailyAttdn = new ArrayList<>();
		
	public StaffAttndStats(int todaysCount, List<Integer> dailyAttdn) {
...
public class StaffAttendanceServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	MongoCollection staffAttendance = db.getCollection("staff_attendance");
		...
		StaffAttndStats stats = new StaffAttndStats(todayCount, dailyAttdn);
